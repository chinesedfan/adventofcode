...
module.exports = function(part, data) {
    ...
    if (part == 1) {
        ...
        while (q.length) {
            ...
            checkAndPush(grid, q, visited, target, eq, time, x, y + 1);
            checkAndPush(grid, q, visited, target, eq, time, x, y - 1);
            checkAndPush(grid, q, visited, target, eq, time, x + 1, y);
            checkAndPush(grid, q, visited, target, eq, time, x - 1, y);
        }
...
function checkAndPush(grid, q, visited, target, eq, time, x, y) {
